...
namespace TTS.Dal
{
    public interface IBaseDal
    {
        ...
        /// <returns></returns>
        T Select<T>(T t, long id);
        /// <summary>
        /// 分页查询列表记录
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        IEnumerable<T> Select<T>(T t, long pageIndex, long pageSize);
        ...
        /// <returns></returns>
        string GetQueryListPagingCondition(IDictionary<string, object> parameters);
    }
    ...
    public abstract class BaseDal: IBaseDal
    {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public virtual T Select<T>(T t, long id)
        {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public virtual IEnumerable<T> Select<T>(T t, long pageIndex, long pageSize)
        {
            using (var con = DbFactory.GetNewConnection())
            {
                var sql =
        ...
        /// <param name="t"></param>
        /// <typeparam name="T"></typeparam>
        public virtual int InsertWithIdentity<T>(T t)
        {
            using (var con = DbFactory.GetNewConnection())
            {
        ...
        /// <param name="t"></param>
        /// <param name="id"></param>
        public virtual void Delete<T>(T t, long id)
        {
            using (var con = DbFactory.GetNewConnection())
            {
        ...
        /// <param name="t"></param>
        /// <typeparam name="T"></typeparam>
        public virtual void Update<T>(T t)
        {
            using (var con = DbFactory.GetNewConnection())
            {
        ...
        /// <param name="parameters">请求参数</param>
        /// <returns></returns>
        public virtual string GetQueryListPagingCondition(IDictionary<string, object> parameters)
        {
            #region 增加分页条件
